...
package org.apache.whirr.service.hdp.hadoop.unit;
...
public class HDPDryRunTest extends BaseServiceDryRunTest {
  ...
  protected Set<String> getInstanceRoles() {
    return ImmutableSet.of("hadoop-namenode",
                           "hadoop-jobtracker",
                           "hadoop-datanode",
                           "hadoop-tasktracker");
  }
  ...
  protected Map<String, String> getTestProperties() {
    ...
    props.put(WHIRR_HADOOP_INSTALL_FN_KEY, HDP_INSTALL_FUNCTION);
    props.put(WHIRR_HADOOP_CONFIGURE_FN_KEY, HDP_CONFIGURE_FUNCTION);
    return props;
  }
}
