...
public class HdpHadoopServiceTest {
  ...
  /**
   * Test the version in use; grep the installed RPM list for hadoop artifacts 
   * @throws Exception
   */
  @Test
  public void testVersion() throws Exception {
    ...
    assertResponsesContain(responses, checkVersion, "hadoop-native");
    assertResponsesContain(responses, checkVersion, "hadoop.");
  }
