...
public class ClusterProxy {
  ...
  public ClusterProxy(ClusterSpec clusterSpec, Cluster cluster) {
    this.clusterSpec = clusterSpec;
    this.cluster = cluster;
  }

  public String[] getProxyCommand(InetAddress remoteHost) throws IOException {
    ...
    String server = remoteHost.getHostAddress();
  ...
  public void start(InetAddress remoteHost) throws IOException {
    // jsch doesn't support SOCKS-based dynamic port forwarding
    // so we need to shell out

    String[] command = getProxyCommand(remoteHost);
